			...
			<div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add Field Agent</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    <form action="add_fagntpro" method="POST">
                    ...
                    <select class="form-control" id="city" name="branch" required>
                        ...
                        ?>
                                        ...
                                        <input type="submit" class="btn btn-primary" id="submit" name="add_employee" value="Add Field Agent" required>
                                    </form>
