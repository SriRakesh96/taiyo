                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Edit Admin Password</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="edit_adm_passpro" method="POST">

                                        <div class="form-row">
                                            <?php  
                                                // Fetch admin details based on the provided admin ID
                                                $adm_id = $_GET['adm_id'];
                                                $adm_fetch = "SELECT * FROM taiyo_admin WHERE access_id='$adm_id' AND act='1'"; 
                                            ...
                                            <input type="hidden" class="form-control" name="adm_id" value="<?php echo $adm_id; ?>">
