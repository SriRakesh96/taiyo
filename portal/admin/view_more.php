               ...
               <div class="table-responsive">
                  <table class="table table-striped">
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="https://techventos.com/spt/field-agent/<?php echo htmlspecialchars($booking['electricity_bill']); ?>" target="_blank" class="btn btn-link">View Electricity Bill</a>
                        </td>
                     </tr>
                     <tr>
                              ...
                              <?php 
                                 ...
                                 if ($gallery_images && is_array($gallery_images)) {
                                     foreach ($gallery_images as $image) {
                                         echo "<img src='https://techventos.com/spt/field-agent/".htmlspecialchars($image)."' alt='Gallery Image'>";
                                     }
                                 } else {
                     ...
                     <tr>
                        <th>Created By</th>
                        <td><?php echo htmlspecialchars($booking['created_by']); ?> || <?php echo htmlspecialchars($booking['emp_name']); ?></td>
                     </tr>
                  </table>
               </div>
            </div>
