...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        // Check if the page load is not from the browser cache
        if (performance.navigation.type === 1 || performance.getEntriesByType('navigation')[0].type === "reload") {
            // If the page was refreshed, do nothing (it already reloaded)
            return;
        }
                        ...
                        <div class="table-responsive">
                            <table id="patients_data" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $patient_fetch = "SELECT * FROM patients WHERE branch='$branch' AND updated_by='$access_id' AND act='2' AND prog='done' ORDER BY id DESC";
